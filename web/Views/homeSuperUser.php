...
<head>
    ...
    <title>Painel de Controle do super - INSPIRERN</title>
</head>
<body>
            ...
            <div>
                ...
                <div class="bg-gray-200 border rounded-md shadow-md p-2 my-4 flex justify-between">
                    <div>
                        ...
                        <?php echo "<p>".$_SESSION['userData']['usu_nome']."</p>"?>
                    </div>
                ...
                <div class="bg-gray-200 border rounded-md shadow-md p-2 my-4 flex justify-between">
                    <div>
                        ...
                        <?php echo "<p>".$_SESSION['userData']['usu_telefone']."</p>"?>
                    </div>
                    <button><span class="p-2 mt-1"><ion-icon name="pencil-outline"></ion-icon></span></button>
                </div>
                <div class="bg-gray-200 border rounded-md shadow-md p-2  my-4 flex justify-between">
                    <div>
                        ...
                        <?php echo "<p>".$_SESSION['userData']['usu_cidade']."</p>"?>
                    </div>
                    <button><span class="p-2 mt-1"><ion-icon name="pencil-outline"></ion-icon></span></button>
                </div> 
                <div class="bg-gray-200 border rounded-md shadow-md p-2  my-4 flex justify-between"> 
                    <div>
                        ...
                        <?php echo "<p>".$_SESSION['userData']['usu_estado']."</p>"?>
                    </div>  
                    <button><span class="p-2 mt-1"><ion-icon name="pencil-outline"></ion-icon></span></button>
                </div>
            ...
            <div>
                ...
                <div class="bg-gray-200 border rounded-md shadow-md p-2 my-4 flex justify-between">
                    <div>
                        ...
                        <?php echo "<p>".$_SESSION['userData']['usu_email']."</p>"?>
                    </div>
                    <button><span class="p-2 mt-1"><ion-icon name="pencil-outline"></ion-icon></span></button>
                </div>
            ...
            <div class="bg-black-gd w-screen h-screen flex items-center justify-center">
                <div class="bg-gray-100 w-1/2 border rounded-md shadow-md px-10 py-5">
                    ...
                    <form action="/updateUser" method="POST" class="flex flex-col space-y-1 mt-2">
                        ...
                        <input type="text" name="name" id="name" placeholder="<?php echo $_SESSION['userData']['usu_nome']; ?>" class="border rounded-md p-2">
                        <label for="city" class="pl-1 pt-2">Cidade</label>
                        <input type="text" name="city" id="city" placeholder="<?php echo$_SESSION['userData']['usu_cidade']; ?>" class="border rounded-md p-2">
                        <label for="state" class="pl-1 pt-2">Estado</label>
                        <input type="text" name="state" id="state" placeholder="<?php echo $_SESSION['userData']['usu_estado']; ?>" class="border rounded-md p-2">
                        <label for="phoneNumber" class="pl-1 pt-2">Telefone</label>
                        <input type="text" name="phoneNumber" id="phoneNumber" placeholder="<?php echo $_SESSION['userData']['usu_telefone']; ?>" class="border rounded-md p-2">
                        <div class="py-2">
            ...
            <div class="bg-black-gd w-screen h-screen flex items-center justify-center">
                <div class="bg-gray-100 w-1/2 border rounded-md shadow-md px-10 py-5">
                    ...
                    <form action="/updateUser" method="POST" class="flex flex-col space-y-1 mt-2">
                        ...
                        <input type="text" name="email" id="email" placeholder="<?php echo $_SESSION['userData']['usu_email']; ?>" class="border rounded-md p-2">
                        <div class="py-2">
                            <button type="submit" class="p-2 border rounded-md border-transparent hover:scale-105 transform ease-in-out bg-blue-600 text-gray-50">Salvar Alterações</button>
